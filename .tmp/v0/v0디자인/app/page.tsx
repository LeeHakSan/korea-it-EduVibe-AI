      ...
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b-2 border-[#e5e5e5]">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/login"
              className="hidden md:inline-block px-5 py-2 font-bold text-[#1cb0f6] hover:bg-[#1cb0f6]/10 rounded-xl transition-all"
            >
              로그인
            </Link>
            <Link
      ...
      <section className="relative py-16 md:py-24 px-4 overflow-hidden">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              href="/login"
              className="w-full sm:w-auto px-10 py-4 bg-white text-[#1cb0f6] text-lg font-bold rounded-2xl border-2 border-[#e5e5e5] shadow-[0_4px_0_0_#e5e5e5] hover:bg-[#f7f7f7] active:shadow-none active:translate-y-1 transition-all"
            >
              이미 계정이 있어요
            </Link>
          </div>
      ...
      <section className="py-16 md:py-24 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-[#777] font-semibold mb-8">
            무료로 가입하고 AI와 함께 파이썬 마스터가 되어보세요.
          </p>
          <Link
            href="/register"
